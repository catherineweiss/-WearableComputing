...
Out of the 561 variables in the original dataset published by Ortiz, et al., only those representing means and standard deviations are described below.  These are the variables selected for inclusion in this analysis. 
